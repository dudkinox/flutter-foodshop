...
class Details11 extends StatefulWidget {
  @override
  _Details11State createState() => _Details11State();
}

class _Details11State extends State<Details11> {
  int number = 1;
          ...
          children: <Widget>[
            ...
            Column(
              ...
              children: const <Widget>[
                ...
                Text(
                  'อกไก่+เฟรนช์ฟรายส์+ขนมปัง+สลัด+ซอสบาบีคิว',
                  style: TextStyle(
                    fontSize: 15.0,
                  ),
                ),
...
//   @override
//   _Details13State createState() => _Details13State();
// }
